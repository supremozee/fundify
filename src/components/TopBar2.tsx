    ...
    <div className="p-4 shadow-md">
      <div className="flex justify-between items-center mx-14">
        <div className="font-bold text-lg flex justify-center items-center">
          <ExplorerSVG />
          <Link to="/proposals" className="ml-2 text-md font-medium">Explore</Link>
        </div>
          ...
          <div className="relative font-[sans-serif] w-max mx-auto">
            ...
            >
              {location.pathname === '/dashboard' ? (
                <Link to={'/'} className="py-2.5 px-5 flex items-center hover:bg-gray-100 text-[#333] text-sm cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
